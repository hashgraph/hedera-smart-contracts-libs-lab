...
public class ExternalStructContract extends Contract {
    ...
    public RemoteFunctionCall<ExternalStruct> get() {
        ...
        return executeRemoteCallSingleValueReturn(function, ExternalStruct.class);
    }

    public RemoteFunctionCall<TransactionReceipt> set(BigInteger id_int, String id_ext) {
        final Function function = new Function(
                FUNC_SET, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Int256(id_int), 
                new org.web3j.abi.datatypes.Utf8String(id_ext)), 
    ...
    public static class ExternalStruct extends DynamicStruct {
        public BigInteger id_int;

        public String id_ext;

        public ExternalStruct(BigInteger id_int, String id_ext) {
            super(new org.web3j.abi.datatypes.generated.Int256(id_int), 
                    new org.web3j.abi.datatypes.Utf8String(id_ext));
            this.id_int = id_int;
            this.id_ext = id_ext;
        }
        ...
        public ExternalStruct(Int256 id_int, Utf8String id_ext) {
            super(id_int, id_ext);
            this.id_int = id_int.getValue();
            this.id_ext = id_ext.getValue();
        }
    }
}
