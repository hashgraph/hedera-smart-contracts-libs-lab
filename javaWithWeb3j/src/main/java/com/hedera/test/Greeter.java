...
public class Greeter extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> newGreeting(Utf8String _greeting) {
        final Function function = new Function(
                FUNC_NEWGREETING, 
    ...
    public String getABI_newGreeting(Utf8String _greeting) {
        final Function function = new Function(
                FUNC_NEWGREETING, 
                Arrays.<Type>asList(_greeting), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<Utf8String> greet() {
    ...
    public FunctionResponse_greet decodeABI_greet(String abiToDecode) {
        final Function function = new Function(FUNC_GREET, 
                Collections.<Type>emptyList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_greet functionResponse_greet = new FunctionResponse_greet();
        functionResponse_greet.return1 = (Utf8String) response.get(0);
        return functionResponse_greet;
    }
    ...
    public static RemoteCall<Greeter> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, Utf8String _greeting) {
    ...
    public static RemoteCall<Greeter> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider, Utf8String _greeting) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_greeting));
    ...
    public String getABI_Constructor(Utf8String _greeting) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_greeting));
        return encodedConstructor;
    }

    public static class FunctionResponse_greet {
