...
public class ComplexStorageNew extends Contract {
    ...
    public FunctionResponse_getFoo decodeABI_getFoo(String abiToDecode) {
        ...
        functionResponse_getFoo.return1 = (Struct0) response.get(0);
    ...
    public String getABI_setFoo(Struct0 _toSet) {
        final Function function = new Function(
                FUNC_SETFOO, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setNaz(Struct5 _naz) {
        final Function function = new Function(
                FUNC_SETNAZ, 
                Arrays.<Type>asList(_naz), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setNuu(Struct3 _toSet) {
        final Function function = new Function(
                FUNC_SETNUU, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setBaz(Struct1 _toSet) {
        final Function function = new Function(
                FUNC_SETBAZ, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setBoz(Struct2 _toSet) {
        final Function function = new Function(
                FUNC_SETBOZ, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<Tuple2<Struct0, Uint256>> getFooUint() {
        ...
        return new RemoteFunctionCall<Tuple2<Struct0, Uint256>>(function,
                new Callable<Tuple2<Struct0, Uint256>>() {
                    @Override
                    public Tuple2<Struct0, Uint256> call() throws Exception {
                        List<Type> results = executeCallMultipleValueReturn(function);
                        return new Tuple2<Struct0, Uint256>(
    ...
    public FunctionResponse_getFooUint decodeABI_getFooUint(String abiToDecode) {
        final Function function = new Function(FUNC_GETFOOUINT, 
                Arrays.asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference <Struct0>() {}, new TypeReference <org.web3j.abi.datatypes.generated.Uint256>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getFooUint functionResponse_getFooUint = new FunctionResponse_getFooUint();
        functionResponse_getFooUint.return1 = (Struct0) response.get(0);
    ...
    public String getABI_setBar(Struct1 _toSet) {
        final Function function = new Function(
                FUNC_SETBAR, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public FunctionResponse_getFooBar decodeABI_getFooBar(String abiToDecode) {
        ...
        functionResponse_getFooBar.return1 = (Struct0) response.get(0);
        functionResponse_getFooBar.return2 = (Struct1) response.get(1);
    ...
    public String getABI_Constructor(Struct0 _foo, Struct1 _bar) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_foo, _bar));
