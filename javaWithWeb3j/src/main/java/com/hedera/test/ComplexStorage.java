...
public class ComplexStorage extends Contract {
    ...
    public FunctionResponse_getBar decodeABI_getBar(String abiToDecode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETBAR, 
                Collections.<Type>emptyList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Bar>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getBar functionResponse_getBar = new FunctionResponse_getBar();
        functionResponse_getBar.return1 = (Bar) response.get(0);
        return functionResponse_getBar;
    }
    ...
    public FunctionResponse_getFoo decodeABI_getFoo(String abiToDecode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETFOO, 
                Collections.<Type>emptyList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Foo>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getFoo functionResponse_getFoo = new FunctionResponse_getFoo();
        functionResponse_getFoo.return1 = (Foo) response.get(0);
        return functionResponse_getFoo;
    }
    ...
    public String getABI_getFooBar() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_GETFOOBAR, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public FunctionResponse_getFooBar decodeABI_getFooBar(String abiToDecode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETFOOBAR, 
                Arrays.asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference <Foo>() {}, new TypeReference <Bar>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getFooBar functionResponse_getFooBar = new FunctionResponse_getFooBar();
        functionResponse_getFooBar.return1 = (Foo) response.get(0);
        functionResponse_getFooBar.return2 = (Bar) response.get(1);
        return functionResponse_getFooBar;
    }

    public RemoteFunctionCall<Tuple2<Foo, Uint256>> getFooUint() {
        ...
        return new RemoteFunctionCall<Tuple2<Foo, Uint256>>(function,
                new Callable<Tuple2<Foo, Uint256>>() {
                    @Override
                    public Tuple2<Foo, Uint256> call() throws Exception {
                        List<Type> results = executeCallMultipleValueReturn(function);
                        return new Tuple2<Foo, Uint256>(
                                (Foo) results.get(0), 
    ...
    public String getABI_getFooUint() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_GETFOOUINT, 
                Arrays.<Type>asList(), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public FunctionResponse_getFooUint decodeABI_getFooUint(String abiToDecode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETFOOUINT, 
                Arrays.asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference <Foo>() {}, new TypeReference <org.web3j.abi.datatypes.generated.Uint256>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getFooUint functionResponse_getFooUint = new FunctionResponse_getFooUint();
        functionResponse_getFooUint.return1 = (Foo) response.get(0);
        functionResponse_getFooUint.return2 = (Uint256) response.get(1);
        return functionResponse_getFooUint;
    }
    ...
    public FunctionResponse_getFuzz decodeABI_getFuzz(String abiToDecode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETFUZZ, 
                Collections.<Type>emptyList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Fuzz>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getFuzz functionResponse_getFuzz = new FunctionResponse_getFuzz();
        functionResponse_getFuzz.return1 = (Fuzz) response.get(0);
        return functionResponse_getFuzz;
    }
    ...
    public FunctionResponse_getNaz decodeABI_getNaz(String abiToDecode) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETNAZ, 
                Collections.<Type>emptyList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Naz>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_getNaz functionResponse_getNaz = new FunctionResponse_getNaz();
        functionResponse_getNaz.return1 = (Naz) response.get(0);
        return functionResponse_getNaz;
    }
    ...
    public String getABI_setBar(Bar _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETBAR, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setBaz(Baz _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETBAZ, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setBoz(Boz _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETBOZ, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setFoo(Foo _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETFOO, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setFuzz(Fuzz _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETFUZZ, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setNaz(Naz _naz) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETNAZ, 
                Arrays.<Type>asList(_naz), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setNuu(Nuu _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETNUU, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public String getABI_setWiz(Wiz _toSet) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETWIZ, 
                Arrays.<Type>asList(_toSet), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public static RemoteCall<ComplexStorage> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, Foo _foo, Bar _bar) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_foo, _bar));
    ...
    public String getABI_Constructor(Foo _foo, Bar _bar) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_foo, _bar));
    ...
    public static class FunctionResponse_getBar {
        public Bar return1;
    }

    public static class FunctionResponse_getFoo {
        public Foo return1;
    }

    public static class FunctionResponse_getFooBar {
        public Foo return1;

        public Bar return2;
    }

    public static class FunctionResponse_getFooUint {
        public Foo return1;

        public Uint256 return2;
    }

    public static class FunctionResponse_getFuzz {
        public Fuzz return1;
    }

    public static class FunctionResponse_getNaz {
        public Naz return1;
    }
}
