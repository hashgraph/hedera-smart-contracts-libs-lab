...
public class Revert extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> set(Uint256 _number) {
    ...
    public String getABI_set(Uint256 _number) {
        final Function function = new Function(
                FUNC_SET, 
                Arrays.<Type>asList(_number), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public FunctionResponse_get decodeABI_get(String abiToDecode) {
        ...
        functionResponse_get.return1 = (Uint256) response.get(0);
