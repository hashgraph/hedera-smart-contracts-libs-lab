...
public class Misc extends Contract {
    ...
    public RemoteFunctionCall<Uint256> _double(Uint256 a) {
    ...
    public String getABI__double(Uint256 a) {
    ...
    public FunctionResponse_double decodeABI__double(String abiToDecode) {
        final Function function = new Function(FUNC_DOUBLE, 
                Collections.<Type>emptyList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        List<Type> response = FunctionReturnDecoder.decode(abiToDecode, function.getOutputParameters());
        FunctionResponse_double functionResponse_double = new FunctionResponse_double();
        functionResponse_double.return1 = (Uint256) response.get(0);
        return functionResponse_double;
    }
    ...
    public static class FunctionResponse_double {
