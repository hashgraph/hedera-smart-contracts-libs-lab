...
public class SimpleStorage extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> set(Uint256 x) {
    ...
    public String getABI_set(Uint256 x) {
        final Function function = new Function(
                FUNC_SET, 
                Arrays.<Type>asList(x), 
                Collections.<TypeReference<?>>emptyList());
    ...
    public RemoteFunctionCall<Uint256> get() {
    ...
    public FunctionResponse_get decodeABI_get(String abiToDecode) {
        ...
        functionResponse_get.retVal = (Uint256) response.get(0);
